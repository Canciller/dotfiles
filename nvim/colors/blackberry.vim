...
call GuiFor("ErrorMsg", "none", s:red_color, "bold")
call GuiFor("Error", "none", s:red_color, "bold")
call GuiFor("DiffText", "none", s:red_color, "bold")
call GuiFor("WarningMsg", "none", s:yellow_color, "bold")
...
call GuiFor("TabLine", s:bg_normal, s:fg_inactive, "none")
call GuiFor("TabLineSel", s:bg_dark, s:fg_normal, "bold")
call GuiFor("TabLineFill", s:bg_normal, s:fg_normal, "none")
call GuiFor("CursorColumn", s:bg_dark, "none", "none")
call GuiFor("CursorLine", s:bg_light, "none", "none")
call GuiFor("Normal", s:bg_dark, s:fg_normal) 
call GuiFor("SignColumn", s:bg_dark, s:fg_normal) 
call GuiFor("ColorColumn", "none", s:red_color, "")

call GuiFor("semshiErrorSign", "none", s:red_color)
call GuiFor("semshiErrorChar", "none", s:red_color, "underline")
